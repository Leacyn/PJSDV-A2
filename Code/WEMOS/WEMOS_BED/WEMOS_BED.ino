...
IPAddress ip(10, 5, 5, 101);// static ip address
IPAddress GW(10, 5, 5, 1); // static gw address
IPAddress netmask(255, 255, 255, 0); // static network mask/ subnet mask
...
void leesDruksensor()
{
  // Begin transmissie met druksensor
  ...
  drukSensor.state = (anin0 / 100); // Waardes druksensor 0 t/m 10
